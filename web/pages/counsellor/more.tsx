...
class __Options extends React.PureComponent<{router: any, questionnaires: Questionnaire[]}> {
	render() {
		let questionnare_cards = this.props.questionnaires.map((val: Questionnaire, i: number) => <QuestionnaireCard questionnaire={val} key={i} />)
	...
	render() {
		...
		if(this.props.is_valid) {
			return <DashboardLayout
				center={<Options questionnaires={this.state.questionnaires} />} 
				title="More"
				prefix="counsellor"
				/>
		} else {
